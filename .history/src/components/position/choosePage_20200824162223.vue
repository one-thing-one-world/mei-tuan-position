  ...
  <div class="box">
    ...
    <div class="byProvince df  a-center">
      ...
      <div class="chooseProvince">
        <el-input readonly v-model="inputProvence" suffix-icon="el-icon-caret-bottom" placeholder="省份"></el-input>
        <div class="chooseProvinceDetail">
          <div class="triangle"></div>
          <div class="triangleWhite"></div>
          <div class="provinceTitle">省份</div>
          <div class="df j-around">
            <div>
              <div class="provinceList-item" v-for="(item,index) in provinceList.slice(0,13)" :key="index">
                {{item.name}}
              </div>
            </div>
            <div>
              <div class="provinceList-item" v-for="(item,index) in provinceList.slice(13,26)" :key="index">
                {{item.name}}
              </div>
            </div>
            <div>
              <div class="provinceList-item" v-for="(item,index) in provinceList.slice(26)" :key="index">
                {{item.name}}
              </div>
            </div>
          </div>
