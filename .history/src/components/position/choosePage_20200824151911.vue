    ...
    <div class="byProvince df a-center">
      ...
      <div class="chooseProvince">
        ...
        <div class="chooseProvinceDetail">
          ...
          <div class="df">
            <div>
              <div v-for="(item,index) in provinceList.slice(0,12)" :key="index">
                {{item.name}}
              </div>
            </div>
            <div>
              <div v-for="(item,index) in provinceList.slice(12,24)" :key="index">
                {{item.name}}
              </div>
            </div>
             <div>
              <div v-for="(item,index) in provinceList.slice(24)" :key="index">
                {{item.name}}
              </div>
            </div>
          </div>
