      ...
      <div class="chooseProvince">
        ...
        <div v-if="inputFlag.seletProvinceFlag" class="chooseProvinceDetail">
          ...
          <div class="df j-around">
            ...
            <div>
              <div ref="provinceList" :class="{'orangeFlag':orangeFlag===index+30}" class="provinceList-item b1" @click="seletProvince(item,index+30)" v-for="(item,index) in provinceList.slice(13,26)" :key="index">
