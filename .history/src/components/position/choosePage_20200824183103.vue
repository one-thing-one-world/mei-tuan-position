      ...
      <div class="chooseProvince">
        ...
        <div v-if="inputFlag.seletProvinceFlag" class="chooseProvinceDetail">
          ...
          <div class="df j-around">
            ...
            <div>
              <div class="provinceList-item b1" :class="{'orangeFlag':orangeFlag===index+100}" @click="seletProvince(item,index+100)" v-for="(item,index) in provinceList.slice(26)" :key="index">
                {{item.name}}
              </div>
            </div>
          </div>
