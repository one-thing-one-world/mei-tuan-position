  ...
  <div class="box df a-center j-bettween  ">
    <div class="top-left">
      ...
      <div class="df  a-center">
        ...
        <div class="swichCity" @click="goToPositionPage">切换城市</div>
          ...
          <div v-if="index===4">
            <div class="index4 df ">
              ...
              <div>
                ...
                <div class="df j-bettween">
                  <div class="topList-box" v-for="(item,index) in topList" :key="index">
  ...
  mounted() {
    this.$api.getPosition().then(
      res => {
        ...
        let city = JSON.parse(someData).city
        this.$store.commit('SetPosition City',city)
