...
.right-item:nth-child(1) .right-item1:hover,.right-item:nth-child(3) .right-item1:hover,.right-item:nth-child(4) .right-item1:hover,.right-item:nth-child(5) .right-item1:hover{
cursor: pointer;
  color: orange;
}
